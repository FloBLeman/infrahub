...
async def test_directories_props(git_upstream_repo_01: dict[str, str | Path], git_repos_dir: Path):
    ...
    assert repo.directory_root == git_repos_dir / git_upstream_repo_01["name"]
    assert repo.directory_branches == git_repos_dir / git_upstream_repo_01["name"] / BRANCHES_DIRECTORY_NAME
    assert repo.directory_commits == git_repos_dir / git_upstream_repo_01["name"] / COMMITS_DIRECTORY_NAME
    assert repo.directory_temp == git_repos_dir / git_upstream_repo_01["name"] / TEMPORARY_DIRECTORY_NAME
